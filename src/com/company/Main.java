...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       Passenger p4 = new Passenger("123456756" , Country.GERMANY  ,Zone.BOW ,"Ahmad kouki matte" , false  ,LocalDate.of(1997, 1, 13) , 4 );
        ...
        Passenger p6 = new Passenger("1234rew54" , Country.BELGIUM   ,Zone.PORT ,"adriano koukio ruizo" , false ,LocalDate.of(2011, 1, 13) , 4 );
        ...
        Passenger p10 = new Passenger("123234sdfs234324456" , Country.BELGIUM  ,Zone.PORT ,"Sidoov nidoov ridov" , false ,LocalDate.of(1986, 1, 12) , 5 );
