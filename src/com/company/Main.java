...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Passenger p3 = new Passenger("123454" , Country.BELGIUM   ,Zone.BOW ,"adrian kouki garcia" , false ,LocalDate.of(2007, 1, 13) , 4 );
        Passenger p2 = new Passenger("1234" , Country.SPAIN  ,Zone.BOW ,"david ruiz bocanegra" , false ,LocalDate.of(2009, 1, 13), 5 );
        Passenger p = new Passenger("12345" , Country.GERMANY  ,Zone.BOW ,"Sido kouki aiwaz" , false  ,LocalDate.of(1996, 1, 13) , 4 );
       Passenger p4 = new Passenger("123456756" , Country.GERMANY  ,Zone.BOW ,"Ahmad ruiz matte" , false  ,LocalDate.of(1997, 1, 13) , 4 );
